...
func LoadModule(bS *client.BotStruct) {
	...
	bS.Handler.Handle(about.AboutMessage, telegram.Command("about", bS.Client.Username()))
	...
	bS.Handler.Handle(localization.ChangeLanguageMessage, telegram.Command("lang", bS.Client.Username()))
	...
	bS.Handler.Handle(help.HelpMenu, telegram.Command("help", bS.Client.Username()))
	...
	bS.Handler.Handle(privacy.PrivacyPolicyMessage, telegram.Command("privacy", bS.Client.Username()))
	bS.Handler.Handle(privacy.PrivacyPolicyCallback, th.CallbackDataMatches(regexp.MustCompile(`^PrivacyPolicy$`)))
	// Start Handlers
	bS.Handler.Handle(start.StartMessage, telegram.Command("start", bS.Client.Username()))
